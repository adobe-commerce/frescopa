/**
 * Default Brand Concierge styling / copy configuration (Experience Platform).
 * Override at runtime with `window.styleConfiguration` before the block decorates.
 */
export const brandConciergeStyleConfiguration = {
  metadata: {
    brandName: 'Fréscopa',
    version: '1.0.0',
    language: 'en-US',
